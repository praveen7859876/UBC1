...
if (isset($_POST["signup"])) {
  ...
  if ($password !== $cpassword) {
    ...
    $sql = "INSERT INTO users (full_name, email,phone,password, token, status) VALUES ('$full_name', '$email','$phone', '$password', '$token', '0')";
...
<body>
      ...
      <div class="signin-signup">
        <form action="" method="post" class="sign-in-form">
          ...
          <div class="input-field">
            ...
            <input type="text" placeholder="Email Address" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" name="email" value="<?php echo $_POST['email']; ?>" required />
          </div>
          <div class="input-field">
        ...
        <form action="" class="sign-up-form" method="post">
          ...
          <div class="input-field">
            <i class="fas fa-user"></i>
            <input type="text" placeholder="Full Name" pattern="[a-zA-Z\s]+" name="signup_full_name" value="<?php echo $_POST["signup_full_name"]; ?>" required />
          </div>
          <div class="input-field">
            <i class="fas fa-envelope"></i>
            <input type="email" placeholder="Email Address" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" name="signup_email" value="<?php echo $_POST["signup_email"]; ?>" required />
          </div>
           <div class="input-field">
            <i class="fas fa-user"></i>
            <input type="text" placeholder="Phone Number"  name="phone" value="<?php echo $_POST["signup_full_name"]; ?>" required />
          </div>
          <div class="input-field">
            <i class="fas fa-lock"></i>
  ...
  <h1><a href="admin/login.php" style="color: white;">admin</a></h1>
</body>
