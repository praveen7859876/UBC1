                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="d-none d-sm-table-cell">Address</th>
                                                <th class="d-none d-sm-table-cell">Service Type</th>
                                                        <th class="d-none d-sm-table-cell">City</th>
                                                                <th class="d-none d-sm-table-cell">Land Mark</th>
...
{               ?>
                                     <tr>
                                        ...
                                        <td class="font-w600"><?php  echo htmlentities($row->stype);?></td>
                                                <td class="font-w600"><?php  echo htmlentities($row->city);?></td>
                                                        <td class="font-w600"><?php  echo htmlentities($row->landmark);?></td>
                                        <?php if($row->Status==""){ ?>
