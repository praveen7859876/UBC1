                        ...
                        <div class="col-6 col-md-4 col-xl-3">
                            <a class="block text-center" href="unread-queries.php">
                                <div class="block-content ribbon ribbon-bookmark ribbon-crystal ribbon-left bg-gd-dusk">
                                    <?php 
$sql ="SELECT ID from feedback where IsRead is null ";
...
?>
                                    ...
                                    <p class="font-w600 text-white">Total Feedback</p>
                                </div>
                            </a>
                        </div>
...
?>
                        ...
                        <div class="col-6 col-md-4 col-xl-4">
                            <a class="block text-center" href="all-user.php">
                                <div class="block-content ribbon ribbon-bookmark ribbon-crystal ribbon-left bg-gd-dusk">
                                     <?php 
...
?>
                                    ...
                                    <p class="font-w600 text-white">Total Customers</p>
                                </div>
                            </a>
                        </div>
