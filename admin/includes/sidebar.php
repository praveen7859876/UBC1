                            ...
                            <div class="content-header-section text-center align-parent sidebar-mini-hidden">
                                ...
                                <div class="content-header-item">
                                    <a class="link-effect font-w700" href="dashboard.php">
                                        ...
                                        <span class="font-size-xl text-dual-primary-dark">ubc</span>
                                    </a>
                                </div>
                                <!-- END Logo -->
                            </div>
...
{               ?>
                        ...
                        <div class="content-side content-side-full">
                            <ul class="nav-main">
                                ...
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="all-users.php"><i class="si si-energy"></i><span class="sidebar-mini-hide">Customers</span></a>
                                    <ul>
                                        <li>
                                            <a href="all-user.php">View Customers</a>
                                        </li>
                                ...
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-user"></i><span class="sidebar-mini-hide">Feedbacks</span></a>
                                    <ul>
                                        <li>
                                            <a href="unread-queries.php">View Feedbacks</a>
                                        </li>
